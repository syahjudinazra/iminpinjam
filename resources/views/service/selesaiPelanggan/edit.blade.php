    ...
    <div class="container w-50 p-3">
        <div class="row addDataForms">
            <div class="d-flex justify-content-between mb-2">
                <h1 class="h3 mb-3 text-gray-800">Edit Data Service Selesai Pelanggan</h1>
            ...
            <form method="POST" action="{{ route('service.updateSelesaiPelanggan', $service->id) }}"
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mt-1" type="radio" id="customer" name="pemilik" value="customer"
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select form-control-chosen" name="device" id="device" required>
                        ...
                        @foreach ($serviceDevice as $device)
                            <option value="{{ $device->name }}" {{ $service->device == $device->name ? 'selected' : '' }}>
                                {{ $device->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select shadow-none" id="pemakaian" name="pemakaian" value="{{ old('pemakaian') }}"
                        required>
