    ...
    <div class="container w-50 p-3">
        <div class="row addDataForms">
            <div class="d-flex justify-content-between mb-2">
                <h1 class="h3 mb-3 text-gray-800">Pindah Data Service Antrian Stock</h1>
            ...
            <form method="POST" action="{{ route('service.updateAntrianStock', $service->id) }}"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control shadow-none" id="kerusakan" name="kerusakan" rows="3"
                        placeholder="Masukan Kerusakan" readonly>{{ $service->kerusakan }}</textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control shadow-none" id="nosparepart" name="nosparepart"
                        placeholder="Masukan No Spare Part" value="{{ $service->nosparepart }}">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control shadow-none" id="snkanibal" name="snkanibal"
                        placeholder="Masukan SN Kanibal" value="{{ $service->snkanibal }}">
                </div>
                <div class="mb-3">
                ...
                <div class="form-group" hidden>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mt-1" type="radio" id="stock" name="pemilik"
                            value="stock" {{ in_array('stock', explode(',', $service->pemilik)) ? 'checked' : '' }}>
                        <label class="form-check-label" for="stock">Stock</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mt-1" type="radio" id="customer" name="pemilik"
                            value="customer" {{ in_array('customer', explode(',', $service->pemilik)) ? 'checked' : '' }}>
                ...
                <div class="form-group" hidden>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mt-1" type="radio" id="validasi" name="status"
                            value="validasi" {{ in_array('validasi', explode(',', $service->status)) ? 'checked' : '' }}
                            checked>
                ...
                <div class="form-group mb-3" hidden>
                    ...
                    <select class="form-select shadow-none" id="pemakaian" name="pemakaian"
                        ...
                        <option value="Baru Di Unboxing"{{ $service->pemakaian == 'Baru Di Unboxing' ? 'selected' : '' }}>
                            Baru Di Unboxing
                        </option>
