...
@section('content')
                    ...
                    <form method="POST" action="{{ route('service.update', $item->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control shadow-none" id="catatan" name="catatan" rows="3" placeholder="Masukan Catatan">{{ $item->catatan }}</textarea>
                            </div>
    ...
    <div class="container-fluid mt-3">
        <div style="overflow: auto">
            <table id="antrianStock-table" class="table table-striped table-bordered nowrap" style="width:100%">
                <thead>
                    <th>No</th>
                    <th>Tanggal Masuk</th>
                    <th>Serial Number</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#antrianStock-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('service.antrianStock') !!}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
