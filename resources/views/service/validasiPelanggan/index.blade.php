...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <h1>Validasi Pelanggan</h1>
        </div>
    </div>

    @foreach ($validasiPelanggan as $item)
        <!-- delete data -->
    ...
    <div class="container-fluid mt-3">
        <div style="overflow: auto">
            <table id="validasiPelanggan-table" class="table table-striped table-bordered nowrap" style="width:100%">
                <thead>
                    <th>No</th>
                    <th>Tanggal Masuk</th>
                    <th>Serial Number</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#validasiPelanggan-table').DataTable({
                processing: true,
                serverSide: true,
                pagingType: 'simple_numbers',
                paging: true,
                pageLength: 10,
                ajax: '{!! route('service.validasiPelanggan') !!}',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
