    ...
    <div class="container w-50 p-3">
        <div class="row addDataForms">
            <div class="d-flex justify-content-between mb-2">
                <h1 class="h3 mb-3 text-gray-800">Lihat Data Service Validasi Pelanggan</h1>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control shadow-none" id="perbaikan" name="perbaikan" rows="3" readonly>{{ $service->perbaikan }}</textarea>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control shadow-none" id="teknisi" name="teknisi"
                    value="{{ $service->teknisi }}" readonly>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control shadow-none" id="nosparepart" name="nosparepart"
                    value="{{ $service->nosparepart }}" readonly>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control shadow-none" id="snkanibal" name="snkanibal"
                    value="{{ $service->snkanibal }}" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control shadow-none" id="tanggalkeluar" name="tanggalkeluar"
                    value="{{ $service->tanggalkeluar }}" readonly>
            </div>
            <div class="form-group">
