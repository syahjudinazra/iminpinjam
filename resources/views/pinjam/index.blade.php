                ...
                <div class="modal-body">
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="penerima" name="penerima" placeholder="Masukan Nama Penerima">
                      </div>
                      <div class="mb-3">
...
<!-- End Move data -->
 ...
 <!-- view kembali data -->
@foreach ($pinjam as $item)
<div class="modal fade" id="viewkembaliModal{{ $item->id }}" tabindex="-1" aria-labelledby="viewkembaliModalLabel{{ $item->id }}" aria-hidden="true">
   <div class="modal-dialog">
       <div class="modal-content">
           <div class="modal-header">
               <h5 class="modal-title" id="viewModalLabel{{ $item->id }}">View Data Pinjam</h5>
           ...
           <div class="modal-body">
               <div class="mb-3">
                 ...
                 <div class="mb-3">
                    <label for="tanggalkembali" class="form-label"><b>Tanggal Kembali</b></label>
                    <input type="date" class="form-control" id="tanggalkembali" name="tanggalkembali" value="{{ $item->tanggalkembali }}" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="penerima" class="form-label"><b>Penerima</b></label>
                    <input type="text" class="form-control" id="penerima" name="penerima" value="{{ $item->penerima }}" readonly>
                  </div>
                  <div class="mb-3">
            ...
            <form method="POST" action="{{ route('users.update', $item->id) }}">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="penerima" class="form-label"><b>Penerima</b></label>
                        <input type="text" class="form-control" id="penerima" name="penerima" value="{{ $item->penerima }}">
                      </div>
                      <div class="mb-3">
                        <label for="kelengkapankembali" class="form-label"><b>Kelengkapan Kembali</b></label>
                        <textarea class="form-control" id="kelengkapankembali" name="kelengkapankembali" rows="3" placeholder="Contoh:Adaptor,Dus,Docking">{{ $item->kelengkapankembali }}</textarea>
                      </div>
                      <div class="mb-3">
                        <label for="status" class="form-label"><b>Status</b></label>
                        <input type="text" class="form-control" id="status" name="status" value="{{ $item->status }}" readonly>
        ...
        <div class="container-fluid mt-3">
            ...
            <tr>
                ...
                <td>
                        ...
                        <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#editkembaliModal{{ $item->id }}"><i class="fa-solid fa-pen-to-square"></i></a>
                        @endif

                        @if(request()->is('kembali'))
                        <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#viewkembaliModal{{ $item->id }}"><i class="fa-solid fa-eye"></i></a>
                        @endif
