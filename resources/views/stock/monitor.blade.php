                                ...
                                <div class="form-group">
                                    ...
                                    <select id="tipe" class="form-select" name="tipe" style="width: 100%" required>
                                        ...
                                        <option value="D3 DS1 EXTENTION DISPLAY (DP)"
                                            data-tokens="D3 DS1 EXTENTION DISPLAY (DP)">D3 DS1 EXTENTION DISPLAY (DP)
                                        </option>
                                        ...
                                        <option value="D3 DS1 Extention Display TS"
                                            data-tokens="D3 DS1 Extention Display TS">D3 DS1 Extention Display TS</option>
                                        ...
                                        <option value="D3 DS1 STAND (1 M CABLE)/DP"
                                            data-tokens="D3 DS1 STAND (1 M CABLE)/DP">D3 DS1 STAND (1 M CABLE)/DP</option>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select id="tipe" class="form-select" name="tipe" required>
                                            ...
                                            <option value="D3 DS1 Extention Display"
                                                data-tokens="D3 DS1 Extention Display"
