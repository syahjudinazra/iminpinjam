...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h3 mb-0 text-gray-800">Cek Pengiriman Pelanggan Stocks</h2>
        </div>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                $('#pengirimanPelanggan-table').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    ...
                    paging: true,
                    pageLength: 10,
                    ajax: '{!! route('stock.pengirimanPelanggan') !!}',
                    columns: [{
                    ...
                    initComplete: function() {
                        var api = this.api();
                        var footer = $('#pengirimanPelanggan-table tfoot tr');
                        $(footer).appendTo('#pengirimanPelanggan-table thead');
