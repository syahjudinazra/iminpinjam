...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <h1 class="h3 mb-3 text-gray-800">Gudang Stocks</h1>
        </div>

        <!-- Edit Data Stock -->
        @foreach ($stockGudang as $item)
            <div class="modal fade" id="stockEditModal{{ $item->id }}" tabindex="-1"
                aria-labelledby="stockEditModalLabel{{ $item->id }}" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <form method="POST" action="{{ route('stock.update', $item->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="stockEditModalLabel{{ $item->id }}">Edit Data Stocks</h5>
