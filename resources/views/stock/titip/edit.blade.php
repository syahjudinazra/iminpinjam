    ...
    <div class="container w-50 p-3">
        <div class="row addDataForms">
            <div class="d-flex justify-content-between mb-2">
                <h1 class="h3 mb-3 text-gray-800">Edit Data Barang Titip</h1>
                <div class="d-flex align-items-center gap-3">
                    <a href="/stock/titip" class="btn btn-danger btn-sm font-weight-bold text-white">
                        Back
                    </a>
                </div>
            </div>
            <hr style="width: -webkit-fill-available;">
            <form method="POST" action="{{ route('stock.updateTitip', $stock->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mt-1" type="radio" id="dipinjam" name="status"
                            value="Dipinjam" {{ in_array('Dipinjam', explode(',', $stock->status)) ? 'checked' : '' }}>
