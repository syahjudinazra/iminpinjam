...
@section('content')
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" action="/kanibal" enctype="multipart/form-data">
                        @csrf
    ...
    @foreach ($kanibal as $item)
        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="POST" action="{{ route('kanibal.update', $item->id) }}"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select selectpicker" name="model" id="model"
                                    ...
                                    <option value="D3 DS1 PRO DP" data-tokens="D3 DS1 PRO DP"
                                        {{ $item->model == 'D3 DS1 PRO DP' ? 'selected' : '' }}>D3 DS1 PRO DP</option>
                                    ...
                                    <option value="M2 Swift 2 Pro" data-tokens="M2 Swift 2 Pro"
                                        {{ $item->model == 'M2 Swift 2 Pro' ? 'selected' : '' }}>M2 Swift 2 Pro
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="teknisi" name="teknisi" value="{{ old('teknisi') }}"
                                    ...
                                    <option value="Barul" data-tokens="Barul"
                                        {{ $item->teknisi == 'Barul' ? 'selected' : '' }}>
                                        Barul
                                    </option>
        ...
        <div class="modal fade" id="deleteModal{{ $item->id }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <form action="{{ route('kanibal.destroy', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                ...
                @foreach ($kanibal as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            @endif
                            @if (Auth::check())
                                <a href="/kanibal/finish/{{ $item->id }}" class="btn btn-success btn-sm"><i
