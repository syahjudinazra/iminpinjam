                    ...
                    <form method="post" action="/kembali" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kelengkapankembali"
                                    name="kelengkapankembali" value="-" readonly>
                            </div>
                            <div class="mb-3">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-warning" data-toggle="modal"
                                data-target="#editModal{{ $item->id }}"><i class="fa-solid fa-pen-to-square"></i></a>
