...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <h1 class="h3 mb-3 text-gray-800">Service Test</h1>
        </div>
    </div>

    <div class="container-fluid mt-3">
        <div style="overflow: auto">
            <table id="serviceTest-table" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <th>No</th>
                    <th>Tanggal Masuk</th>
                    <th>Serial Number</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#serviceTest-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('serviceTest.index') !!}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
