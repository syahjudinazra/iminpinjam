    ...
    <div class="container w-50 p-3">
        <div class="row addDataForms">
            <div class="d-flex justify-content-between mb-2">
                <h1 class="h3 mb-3 text-gray-800">Move Data Service</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" hidden>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mt-1" type="radio" id="customer" name="pemilik"
                                value="customer" {{ in_array('customer', explode(',', $item->pemilik)) ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mt-1" type="radio" id="antrian" name="status"
                                value="antrian" {{ in_array('antrian', explode(',', $item->status)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mt-1" type="radio" id="validasi" name="status"
                                value="validasi" {{ in_array('validasi', explode(',', $item->status)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mt-1" type="radio" id="selesai" name="status"
                                value="selesai" {{ in_array('selesai', explode(',', $item->status)) ? 'checked' : '' }}>
                    ...
                    <div class="form-group mb-3" hidden>
                        ...
                        <select class="form-select form-control-chosen" name="device" id="device" required>
                            ...
                            @foreach ($serviceDevice as $device)
                                <option value="{{ $device->name }}" {{ $item->device == $device->name ? 'selected' : '' }}>
                                    {{ $device->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3" hidden>
                        ...
                        <select class="form-select shadow-none" id="pemakaian" name="pemakaian"
                            ...
                            <option value="Baru Di Unboxing"{{ $item->pemakaian == 'Baru Di Unboxing' ? 'selected' : '' }}>
                                Baru Di Unboxing
                            </option>
                            <option value="7 Hari Kurang"{{ $item->pemakaian == '7 Hari Kurang' ? 'selected' : '' }}>
                                7 Hari Kurang
                            </option>
                            <option value="1 Tahun Kurang"{{ $item->pemakaian == '1 Tahun Kurang' ? 'selected' : '' }}>
                                1 Tahun Kurang
                            </option>
                            <option value="1 Tahun Lebih"{{ $item->pemakaian == '1 Tahun Lebih' ? 'selected' : '' }}>
                                1 Tahun Lebih
                            </option>
                        </select>
                    </div>
