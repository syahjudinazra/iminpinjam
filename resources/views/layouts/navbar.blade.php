                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ Request::is('servicedone*') ? 'active' : '' }}" href="#">Service Done</a>
                            <a class="collapse-item {{ Request::is('servicepending*') ? 'active' : '' }}" href="#">Service Pending</a>
                            <a class="collapse-item {{ Request::is('kanibal*') ? 'active' : '' }}" href="#">Kanibal</a>
                        </div>
                    </div>
                </li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <form method="GET" action="{{ route('search.index') }}"
                ...
                <div class="input-group">
                    <input type="search" name="search" value="{{ request()->input('search') }}" class="form-control bg-light border-0 small" placeholder="Search for..."
